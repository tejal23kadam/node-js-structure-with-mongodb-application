                ...
                <div className='row '>
                    ...
                    <div className='col-md-6 d-none d-md-block bg-color p-5 sign-up-left'>
                        <div className='text-wrap  text-center  '>
                            ...
                            <button type="button" className="form-control btn bg-color btn-outline text-white btn-animation" ><Link className='text-white ' style={{ textDecoration: 'none' }} to="/signup">Sign Up</Link></button>
                        </div>
                    </div>

                    <div className='col-md-6 bg-light ml-3 mr-3 ml-md-0 mr-md-0 p-3 sign-up-right'>
                        ...
                        <form>
                            ...
                            <div className='text-wrap p-1 text-center d-md-none '>
                                <div className='text '>
