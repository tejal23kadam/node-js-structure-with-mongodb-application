                        ...
                        <div className="row justify-content-md-center text-center">
                            <div className="col-md-12 col-lx-8">
                                <div className="content-holder mt-5">
                                    ...
                                    <div className="row">
                                        <div className=" col-md-4 col-ms-12 mb-5 ">
                                            <h3>1</h3>
                        ...
                        <div className="col-12">
                            <div className="row">
                                ...
                                <div className="col-lg-3 offset-lg-0 col-md-5 offset-md-1 col-sm-6">
                                    <div className="category-block">
                                        <div className="header-text">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
                                ...
                                <div className="col-lg-3 offset-lg-0 col-md-5 offset-md-1 col-sm-6">
                                    <div className="category-block">
                                        <div className="header-text">
                                            {/* <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                                ...
                                <div className="col-lg-3 offset-lg-0 col-md-5 offset-md-1 col-sm-6">
                                    <div className="category-block">
                                        <div className="header-text">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-clock-history" viewBox="0 0 16 16">
